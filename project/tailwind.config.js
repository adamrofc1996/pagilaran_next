  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'leaf-float': 'leafFloat 3s ease-in-out infinite', // Updated duration to 3s
        'pulse-soft': 'pulseSoft 2s ease-in-out infinite',
        'scale-in': 'scaleIn 0.5s ease-out',
        'tea-leaf-dance': 'teaLeafDance 4s ease-in-out infinite', // New tea leaf animation
      },
      keyframes: {
        fadeIn: {
        ...
        // Enhanced leaf float animation with 80-120% scale and responsive positioning
        leafFloat: {
          '0%': { 
        ...
        // New tea leaf dance animation for the button
        teaLeafDance: {
          '0%': { 
